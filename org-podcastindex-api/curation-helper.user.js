...
(function() {
    ...
    const authors = [
        "Aeschylus", "Aesop", "Anacreon", "Apuleius", "Aristophanes", "Aristotle", "Augustine of Hippo", "Marcus Aurelius",
        "Caesar, Julius", "Catullus", "Demosthenes", "Diodorus Siculus", "Diogenes Laërtius", "Epicurus", "Euripides", "Galen",
        "Herodotus", "Hesiod", "Hippocrates", "Homer", "Horace", "Josephus, Flavius", "Juvenal", "Livy", "Lucian of Samosata",
        "Lucretius", "Pindar", "Plato", "Plautus", "Pliny the Elder", "Pliny the Younger", "Plutarch", "Polybius", "Propertius",
        "Quintilian", "Sallust", "Sappho", "Seneca the Younger", "Sophocles", "Suetonius", "Tacitus", "Terence", "Theocritus",
        "Thucydides", "Virgil", "Xenophon",

        "Aesop", "Alcott, Louisa May", "Apuleius", "Augustine of Hippo", "Aurelius, Marcus", "Austen, Jane",
        "Balzac, Honoré de", "Baudelaire, Charles", "Blake, William", "Brontë, Charlotte and Emily", "Burns, Robert",
        "Caesar, Julius", "Carroll, Lewis", "Catullus", "Cervantes, Miguel de", "Chekhov, Anton", "Cicero, Marcus Tullius",
        "Coleridge, Samuel Taylor", "Cooper, James Fenimore",
        "Defoe, Daniel", "Descartes, René", "Dickens, Charles", "Dickinson, Emily", "Dostoevsky, Fyodor", "Douglass, Frederick",
        "Dumas, Alexandre",
        "Eliot, George", "Emerson, Ralph Waldo",
        "Fielding, Henry", "Flaubert, Gustave",
        "Galen", "Goethe, Johann Wolfgang von", "Gogol, Nikolai", "Grimm, Jacob and Wilhelm",
        "Hawthorne, Nathaniel", "Horace", "Hugo, Victor",
        "Ibsen, Henrik", "Irving, Washington",
        "Juvenal",
        "Kant, Immanuel", "Keats, John",
        "Livy", "Lucretius",
        "Melville, Herman", "Milton, John", "Molière",
        "Nietzsche, Friedrich",
        "Ovid",
        "Plautus", "Pliny the Elder and Pliny the Younger", "Poe, Edgar Allan", "Propertius", "Pushkin, Alexander",
        "Quintilian",
        "Rousseau, Jean-Jacques",
        "Sallust", "Schiller, Friedrich", "Scott, Sir Walter", "Seneca the Younger", "Shakespeare, William", "Shelley, Mary",
        "Shelley, Percy Bysshe", "Stevenson, Robert Louis", "Stoker, Bram", "Stowe, Harriet Beecher", "Suetonius", "Swift, Jonathan",
        "Tacitus", "Terence", "Thoreau, Henry David", "Tolstoy, Leo", "Twain, Mark",
        "Verne, Jules", "Virgil", "Voltaire",
        "Wells, H.G.", "Whitman, Walt", "Wilde, Oscar", "Wollstonecraft, Mary", "Wordsworth, William"
    ];
